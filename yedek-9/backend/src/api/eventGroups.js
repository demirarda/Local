...
router.get('/', authenticateToken, requireProductOps('event_groups'), async (req, res) => {
...
router.post('/', authenticateToken, requireProductOps('event_groups'), async (req, res) => {
...
router.post('/:id/rituals/:ritualId', authenticateToken, requireProductOps('event_groups'), async (req, res) => {
...
router.delete('/:id/rituals/:ritualId', authenticateToken, requireProductOps('event_groups'), async (req, res) => {

 ...
 * Shape: {key, EN, TR, route?} · Concept words NEVER translated. UI uses keys.
 * Keep in sync with mobile/src/i18n/stringTable.js
 */
import { CHIP_COPY_STUBS } from './chipCopyStubs.js';

    ...
    <View style={styles.container}>
      ...
      {totalViewers > 0 && (
        <View style={styles.livePill}>
          ...
          <Text style={styles.liveText}>{formatViewerCount(totalViewers)} ŞU AN BAKIYOR</Text>
        </View>
      )}
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  left: { flexDirection: 'row', alignItems: 'center', gap: 10, zIndex: 1 },
  iconWrap: {
    width: 28,
    height: 28,
    borderRadius: 14,
  ...
  nameRow: { flexDirection: 'row', alignItems: 'baseline', gap: 4, marginTop: 2 },
  nameBig: {
  ...
  nameSmall: { fontFamily: fonts.serif, fontSize: 13, fontStyle: 'italic', color: colors.text500 },
  livePill: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 5,

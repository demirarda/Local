      ...
      <View style={styles.cover}>
        ...
        {data.handwrittenQuote && (
          <Text style={styles.handwritten} numberOfLines={2}>
            {cleanText(data.handwrittenQuote)}
          </Text>
        )}
      </View>
      ...
      <View style={styles.body}>
        <View style={styles.identityRow}>
          ...
          <View style={styles.identityInfo}>
            <Text style={styles.name}>{cleanText(data.name)}</Text>
            {data.firstMetRitual && (
              <Text style={styles.meta} numberOfLines={1}>
                {cleanText(data.firstMetRitual.name)}'ta tanıştınız · {formatDaysSince(data.firstMetRitual.date)}
              </Text>
            )}
          </View>
        </View>

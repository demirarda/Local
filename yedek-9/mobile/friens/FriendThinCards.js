    ...
    >
      ...
      <View style={styles.nowInfo}>
        <View style={styles.nowNameRow}>
          <Text style={styles.nowName}>{cleanText(data.name)}</Text>
          <View style={styles.nowStatusBadge}>
            <Text style={styles.nowStatusText}>AKTİF</Text>
          </View>
        </View>
        <Text style={styles.nowActivity} numberOfLines={1}>
          <Text style={styles.nowActivityBold}>{cleanText(data.activeRitual?.name)}</Text>
          {data.activeRitual?.venue ? ` · ${cleanText(data.activeRitual.venue)}` : ''}
        </Text>
      </View>
    ...
    <View style={styles.rekindleContainer}>
      ...
      <View style={styles.rekindleInfo}>
        <View style={styles.rekindleNameRow}>
          <Text style={styles.rekindleName}>{cleanText(data.name)}</Text>
          <HeatIndicator heat={data.heat} />
        </View>
        <Text style={styles.rekindleLastMeet} numberOfLines={1}>
          {data.firstMetRitual ? (
            <>
              <Text style={styles.rekindleBold}>{cleanText(data.firstMetRitual.name)}</Text>
              'da tanışmıştınız
            </>
          ) : (

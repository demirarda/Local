    ...
    >
      ...
      <View style={styles.quoteFooter}>
        <Text style={styles.quoteByline}>
          <Text style={styles.quoteBylineBold}>{data.authorName}</Text>
        </Text>
        {data.context && <Text style={styles.quoteContext}>{data.context}</Text>}
      </View>
    </TouchableOpacity>
  );
}
        ...
        <View style={styles.newConnCompactBody}>
          ...
          {data.firstMetRitual && (
            <Text style={styles.newConnFromCompact} numberOfLines={1}>
              <Text style={styles.newConnFromBold}>{data.firstMetRitual.name}</Text>
            </Text>
          )}
        </View>
    ...
    >
      ...
      <View style={styles.newConnBody}>
        ...
        <View style={styles.newConnInfo}>
          <Text style={styles.newConnName}>{data.name}</Text>
          {data.firstMetRitual && (
